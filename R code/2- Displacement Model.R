...
tag_info <- fread("MetaData/Tagged bird summary data new.csv")
...
final_pairs4$Dist_difm <- (final_pairs4$Step_len*1000) - (final_pairs4$SL_control*1000)
...
## add winter column
final_pairs4$year <- as.numeric(as.character(final_pairs4$year))
